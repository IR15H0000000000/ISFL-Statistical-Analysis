...
def _season_leaders(engine, table, season: int, top: int, order_col: str, game_type: str = "regular"):
    ...
    skip_cols = {"id", "game_id", "season", "game_type"}
...
def passing_leaders(
    ...
    return _season_leaders(request.app.state.engine, player_game_passing_table, season, top, "yards", game_type)
...
def rushing_leaders(
    ...
    return _season_leaders(request.app.state.engine, player_game_rushing_table, season, top, "yards", game_type)
...
def receiving_leaders(
    ...
    return _season_leaders(request.app.state.engine, player_game_receiving_table, season, top, "yards", game_type)
...
def defensive_leaders(
    ...
    return _season_leaders(request.app.state.engine, player_game_defensive_table, season, top, "tackles", game_type)
...
def team_stats(
    ...
    t = team_games_table
    skip = {"id", "game_id", "opponent", "is_home", "game_type"}
...
def player_game_log(
    ...
    engine = request.app.state.engine
    stmt = select(table).where(table.c.player_id == player_id).where(table.c.game_type == game_type)
